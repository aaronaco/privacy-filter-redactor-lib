...
class ViterbiCRFDecoder:
    ...
    def _get_transition_biases(self, mode: DecodingMode) -> Dict[str, float]:
        ...
        return {key: 0.0 for key in [
            "background_stay", "background_to_start", "inside_to_continue",
            "inside_to_end", "end_to_background", "end_to_start"
        ]}
    ...
    def _build_transition_matrix(self) -> torch.Tensor:
        ...
        for i in range(self.num_labels):
            ...
            for j in range(self.num_labels):
                ...
                elif tag_i == BIOTag.BEGIN and tag_j in [BIOTag.INSIDE, BIOTag.END] and cat_i == cat_j:
                ...
                elif tag_i == BIOTag.INSIDE and tag_j in [BIOTag.INSIDE, BIOTag.END] and cat_i == cat_j:
                    is_continue = tag_j == BIOTag.INSIDE
                    bias_key = "inside_to_continue" if is_continue else "inside_to_end"
                    score += self.transition_biases[bias_key]
                    is_valid_transition = True
                ...
                elif tag_i in [BIOTag.END, BIOTag.SINGLE] and tag_j in [BIOTag.BEGIN, BIOTag.SINGLE]:
    ...
    def _parse_label(self, label: str) -> Tuple[BIOTag, Optional[str]]:
