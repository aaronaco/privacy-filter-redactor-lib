...
def main():
    ...
    text = "Hello, my name is Jason Statham. My email is jason.statham@example.com and my phone number is 555-0199. I live at 123 Main St, New York, NY."
    ...
    for ent in entities:
        print(f" - Found {ent.label}: '{ent.text}' at {ent.start}:{ent.end} (score: {ent.score:.4f})")
